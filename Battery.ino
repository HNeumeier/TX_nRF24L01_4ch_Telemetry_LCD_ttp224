...
void TX_batt_check()
{
  ...
  val_TX_battery = read_adc(7) * (TX_BATTERY_VOLTAGE / 1023 * 2.5);

  // Calculating correct value voltage for battery bar
  calc_bar_batt = (val_TX_battery) /* + correct_volt 2 */;
  calc_max_batt = TX_BATTERY_VOLTAGE;
  calc_min_batt = TX_MONITORED_VOLTAGE;
